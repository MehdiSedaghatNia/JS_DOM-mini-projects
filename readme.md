...
This is from the `Javscript course on Udemy` a course by `John Smilga`.
...
15	Slider	Image carousel	setInterval, array methodsf).

## Project Navigation

I've created a main page contains a simple list of links to each individual project. Just click on any link to open that project in your browser. that acts as a launchpad for all my JavaScript projects. Think of it as a menu where each project is just one click away!
